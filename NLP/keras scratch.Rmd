...
terms <- row.names(vectors)

library(lsa)
library(LSAfun)

cosine(vectors["peanut",],vectors["orange",])
Cosine('peanut','orange', tvectors = vectors)


test <- textdata::embedding_glove6b(dimensions = 100)

#vectors<-read.table("~/Downloads/glove.6B/glove.6B.300d.txt")
